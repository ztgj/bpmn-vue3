  ...
  <div class="panel-tab__content">
    ...
    <el-drawer v-model="listenerFormModelVisible" title="执行监听器" :size="width + 'px'" append-to-body destroy-on-close>
      <el-form size="small" :model="listenerForm" label-width="96px" ref="listenerFormRef" @submit.prevent>
        ...
        >
          <el-input v-model="listenerForm.class" allowClear />
        </el-form-item>
        <el-form-item
        ...
        <template v-if="listenerForm.listenerType === 'scriptListener'">
          ...
          >
            <el-input v-model="listenerForm.scriptFormat" allowClear />
          </el-form-item>
          <el-form-item
            label="脚本类型"
            prop="scriptType"
          ...
          >
            <el-input v-model="listenerForm.value" allowClear />
          </el-form-item>
          <el-form-item
          ...
          >
            <el-input v-model="listenerForm.resource" allowClear />
          </el-form-item>
        </template>
        ${
          isTaskListener
            ? "<el-form-item label='定时器类型' prop='eventDefinitionType' key='eventDefinitionType'>" +
              ...
              "<el-input v-model='listenerForm.eventDefinitions' allowClear />" +
              '</el-form-item>'
            : ''
        }
      </el-form>
    ...
    <el-dialog title="字段配置" v-model="listenerFieldFormModelVisible" width="600px" append-to-body destroy-on-close>
      <el-form :model="listenerFieldForm" size="small" label-width="96px" ref="listenerFieldFormRef" style="height: 136px" @submit.prevent>
        <el-form-item label="字段名称：" prop="name" :rules="{ required: true, trigger: ['blur', 'change'] }">
          <el-input v-model="listenerFieldForm.name" allowClear />
        </el-form-item>
        ...
        <el-form-item
          ...
          :rules="{ required: true, trigger: ['blur', 'change'] }"
        >
          <el-input v-model="listenerFieldForm.string" allowClear />
        </el-form-item>
        <el-form-item
          ...
          :rules="{ required: true, trigger: ['blur', 'change'] }"
        >
          <el-input v-model="listenerFieldForm.expression" allowClear />
        </el-form-item>
      </el-form>
